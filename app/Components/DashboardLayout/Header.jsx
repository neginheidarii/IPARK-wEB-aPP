...
const Header = () => {
  ...
  const menuItems = [
    ...
    { href: "/user/clients", label: "API Clients", Icon: ArrowsPointingInIcon },
    { href: "/invoices", label: "Invoices", Icon: DocumentTextIcon },
    { href: "/payment_links", label: "Payment Links", Icon: LinkIcon },
    {
      href: "/subscriptions",
            ...
            <PopoverContent className={"bg-red-300 p-0"}>
              <Card className="p-2">
                ...
                <CardBody className="px-3 text-small text-default-400">
                  ...
                  >
                    <ListboxItem key="text">Switch business</ListboxItem>
